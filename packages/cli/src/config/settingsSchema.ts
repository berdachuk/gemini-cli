...
const SETTINGS_SCHEMA = {
  ...
  localModel: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Settings for local OpenAI-compatible model backends.',
    showInDialog: false,
    properties: {
      backend: {
        type: 'enum',
        ...
        requiresRestart: true,
        default: undefined as string | undefined,
        description: 'Local inference backend to use for Gemma 4 aliases.',
        showInDialog: false,
        options: [
      ...
      baseUrl: {
        type: 'string',
        label: 'Local Backend Base URL',
        category: 'Model',
        requiresRestart: true,
        default: undefined as string | undefined,
        description: 'Override the local backend API base URL.',
        showInDialog: false,
      },
      providers: {
        type: 'object',
        label: 'Local Backend Providers',
        category: 'Model',
        requiresRestart: true,
        default: {},
        description:
          'Optional per-provider defaults for local backend API endpoints.',
        showInDialog: false,
        properties: {
          ollama: {
            type: 'object',
      ...
      modelMapping: {
        ...
        default: {},
        description:
          'Optional alias-to-model mappings for discovered local Gemma 4 models.',
        showInDialog: false,
        properties: {
          gemma4: {
            type: 'string',
      ...
      toolFiltering: {
        ...
        default: {},
        description:
          'Optional FunctionGemma-based tool relevance filtering. Ollama-only.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            label: 'Enable Tool Filtering',
            category: 'Model',
            requiresRestart: true,
            default: false,
            description:
              'When enabled, FunctionGemma pre-filters tools to reduce context usage.',
            showInDialog: false,
          },
          model: {
            type: 'string',
